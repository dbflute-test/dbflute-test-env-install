package org.docksidestage.install.dbflute.allcommon;
 ...
 */
@Configuration
@ComponentScan(value="org.docksidestage.install.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new org.docksidestage.install.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new org.docksidestage.install.dbflute.allcommon.ImplementedInvokerAssistant();
    }
